...
public class ConverterLakhFormat {
    ...
    private static void preparePowerList() {
        if (powersList == null) {
            ...
            powersList.add(new PowerName(5L, "Lakh"));
            powersList.add(new PowerName(7L, "Crore"));
            powersList.add(new PowerName(9L, "Arab"));
            powersList.add(new PowerName(11L, "Kharab"));
            powersList.add(new PowerName(13L, "Nil"));
            powersList.add(new PowerName(15L, "Padma"));
            powersList.add(new PowerName(17L, "Shankh"));
            //arab,kharab,nil,padma,shankh
        }
    }
